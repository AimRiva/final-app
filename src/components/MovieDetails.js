        ...
        <div className="container px-4 px-lg-5 my-5">
            <div className="row gx-4 gx-lg-5 align-items-center">
                <div className="col-md-6">
                  {/* <img className="card-img-top mb-5 mb-md-0" src={props.movie.main_picture.medium} alt="poster" /> */}
                </div>
                <div className="col-md-6">
                    {/* <div className="small mb-1">{props.movie.alternative_titles}</div> */}
                    <h1 className="display-5 fw-bolder">{props.movie.title}</h1>
                    <div className="fs-5 mb-5">
                    <div className="small btn bg-warning">Score: {props.movie.mean} 
                    </div><span class="fs-6">  {props.movie.num_list_users} Users</span> 
                    </div>
